export function DynamicCanvasMobile() {
    ...
    function state(s){
      ...
      if (s==="init"){
        ...
        wrapper.addEventListener('mousemove',function(e){
          app.universe.light.position.x = (e.clientX);
          app.universe.light.position.y = (e.clientY);
        });
    ...
    class Application {
      ...
      render(){
        ...
        gradient.addColorStop(0,"#0B0438 ");
    ...
    class Universe{
      constructor(width,height){
        ...
        this.light = new Light(width*.75,height*.75);
      }
    ...
    class Box {
      ...
      getRandomColor() {
       let color=['#0EEBEB','#FF124F','#7A04EB']
    ...
    window.onload = function() {
      ...
      // followMe("init");
        ...
        return (
            ...
            //     </div>
            // </div>
            <div id="game-wrapper" style={{overflowY:"hidden"}}>
    
                          <div className="canvasTextElements" style={{background:"transparent", position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-50%)"}}>  
                     <div className="canvasHeading" style={{fontSize: "10vw",
                fontWeight: "bold",
                marginBottom: "1.7vh",
                fontFamily: 'Alatsi',
                letterSpacing: "1vw",
    ...
    export default DynamicCanvasMobile;